  ...
  return (
    <>
      ...
      <section className="sr-only" aria-hidden="false">
        <h1>פה קרוב — עסקים קטנים ודוכנים על מפה בזמן אמת</h1>
        <p>
          פה קרוב היא פלטפורמה למציאת רוכלים, דוכנים ועסקים ניידים בסביבתך.
        ...
        <p>
          ...
          פה קרוב עוזרת למצוא עסקים פתוחים וקרובים לפי מיקום, קטגוריה ושעות פעילות.
        </p>
        <ul>
          <li>רוכלים ניידים</li>
