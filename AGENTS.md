...
- Customer-facing support and business contact are email/phone-only; do not restore WhatsApp links, sharing, profile inputs, admin inputs, or public WhatsApp fields. Legacy database columns and analytics event values remain only for historical compatibility.
