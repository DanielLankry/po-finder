...
- Visual source: temporary local reference image (not committed)
- Category/button implementation:
  [design-qa-home.png](assets/design-qa-home.png)
- Duration-pricing implementation:
  [design-qa-pricing-duration-final.png](assets/design-qa-pricing-duration-final.png)
