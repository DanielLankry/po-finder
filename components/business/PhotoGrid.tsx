      ...
      <div className="relative h-80 md:h-[420px] rounded-2xl overflow-hidden grid grid-cols-3 gap-1">
        ...
        {sorted.length > 3 && (
          <button
            ...
            className="absolute bottom-4 left-4 bg-white border border-stone-200 text-stone-700 text-sm font-medium px-4 py-2 rounded-xl hover:bg-stone-50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2D6A4F] shadow-card"
          >
