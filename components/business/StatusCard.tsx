...
export default function StatusCard({ business, schedule }: StatusCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Today's note */}
      {schedule?.note && (
        <p className="text-slate-600 text-sm bg-[#EFF5F0] border border-[#DDEBE0] rounded-xl p-3 mb-5">
          {schedule.note}
        </p>
      )}
      ...
      <div className="space-y-3">
        ...
        {business.phone && (
          <a
            ...
            className="flex items-center justify-center gap-2 w-full h-11 rounded-xl border border-slate-200 text-slate-700 hover:bg-[#EFF5F0] hover:border-[#C3DCC9] hover:text-[#1F5038] font-medium text-sm transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2D6A4F] btn-press"
          >
        ...
        {business.instagram && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-2 w-full h-10 text-slate-400 hover:text-[#2D6A4F] text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2D6A4F] rounded-xl"
          >
